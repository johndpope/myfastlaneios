...
class CustomVideoPlayerControls: UIView {
    ...
    func createView(subtitleUrlString:String, isSubtitleAvailable:Bool) -> Void {
        ...
        backbutton?.imageView?.tintColor = Utility.hexStringToUIColor(hex: AppConfiguration.sharedAppConfiguration.appTextColor ?? AppConfiguration.sharedAppConfiguration.themeFontColor ?? "ffffff")
        ...
        let buttonImageView: UIImageView = UIImageView.init(image: #imageLiteral(resourceName: "Fullscreen.png"))
        
        self.fullScreenButton?.setImage(buttonImageView.image?.withRenderingMode(.alwaysTemplate), for: .normal)
        self.fullScreenButton?.imageView?.tintColor = Utility.hexStringToUIColor(hex: "ffffff")
...
//        airPlayButton.addGestureRecognizer(lpgr)
        ...
        let playSelectedImageView: UIImageView = UIImageView.init(image: #imageLiteral(resourceName: "Pause.png"))
        let playNormalImageView: UIImageView = UIImageView.init(image: #imageLiteral(resourceName: "play.png"))
        
        self.playButton?.setImage(playNormalImageView.image?.withRenderingMode(.alwaysTemplate), for: .normal)
        self.playButton?.setImage(playSelectedImageView.image?.withRenderingMode(.alwaysTemplate), for: .selected)
        self.playButton?.imageView?.tintColor = Utility.hexStringToUIColor(hex: "ffffff")
        ...
        let rewindImageView: UIImageView = UIImageView.init(image: #imageLiteral(resourceName: "RewindButton.png"))
        
        self.rewindButton?.setImage(rewindImageView.image?.withRenderingMode(.alwaysTemplate), for: .normal)
        self.rewindButton?.imageView?.tintColor = Utility.hexStringToUIColor(hex: "ffffff")
        ...
        let forwardImageView: UIImageView = UIImageView.init(image: #imageLiteral(resourceName: "Forward.png"))
        
        self.forwardButton?.setImage(forwardImageView.image?.withRenderingMode(.alwaysTemplate), for: .normal)
        self.forwardButton?.imageView?.tintColor = Utility.hexStringToUIColor(hex: "ffffff")
